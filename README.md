...
:warning: <sub>Estou finalizando os testes em um código para treinar a similaridade semântica com o `BERTimbau` ou outras LLMs como o `ult5-pt-small` (com 1024 tokens de entrada e bem leve) e o `
gtr-t5-xxl` (muito bom para similaridade em PTBR, mas precisa de muita máquina). Exemplos de uso disponíveis no agrupamento com modelos prontos ou personalizados.</sub>
