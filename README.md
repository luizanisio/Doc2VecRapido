...
:warning: Estou trabalhando no código para treinar a similaridade do `BERTimbau` ou outras LLMs como o `ult5-pt-small` (com 1024 tokens de entrada) e o `
gtr-t5-xxl` (muito bom para similaridade em PTBR). Em breve disponibilizo para uso no agrupamento com modelos prontos ou personalizados.
